      ...
      <View style={styles.mainContainer}>
        ...
        <View style={styles.section}>
          ...
          <Button
            ...
            text='iscriviti'
            onPress={() =>
              Communications.web('https://mc1l3.mailrouter.it/user/register', true)
            }
          />
          <Text style={styles.sectionText}>
          ...
          <Text style={{ textAlign: 'center' }}>
            <Icon
              ...
              onPress={() =>
                Communications.web(
                  'https://mc1l3.mailrouter.it/user/register_facebook',
                  true
                )
              }
            />
